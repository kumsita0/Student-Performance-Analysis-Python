...
- Calculated the average Science score.
- Identified the student with the highest Math score.
...
- Computed the overall average Science score for all students.
- Determined the highest-performing student in Math.
- Determined the highest-performing student in Science.
...
- Analyze additional subjects.
- Calculate grade distributions and overall rankings.
- Build an interactive dashboard for student performance.
